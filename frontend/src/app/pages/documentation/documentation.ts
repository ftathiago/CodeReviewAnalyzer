...
ng serve</code></pre>
            ...
            <p class="text-lg mb-4">
                ...
                been separated so that you can easily identify what is necessary
            ...
            <p class="text-lg mb-4">
                ...
                application shell uses custom CSS.
            </p>

            <div class="font-semibold text-xl mb-4">Variables</div>
            <p class="text-lg mb-4">
                CSS variables used in the template are derived from the applied
                PrimeNG theme. Customize them through the CSS variables in
                <span
                    class="bg-highlight px-2 py-1 rounded-border not-italic text-base"
