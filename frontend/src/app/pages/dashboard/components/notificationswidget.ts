    ...
    template: `<div class="card">
        ...
        <ul class="p-0 mx-0 mt-0 mb-6 list-none">
            ...
            <li class="flex items-center py-2">
                ...
                <span
                    class="text-surface-700 dark:text-surface-100 leading-normal"
                    >Your request for withdrawal of
                    <span class="text-primary font-bold">$2500.00</span> has
                    been initiated.</span
                >
            </li>
        </ul>
        ...
        <ul class="p-0 m-0 list-none">
            ...
            <li class="flex items-center py-2 border-b border-surface">
                ...
                <span
                    class="text-surface-900 dark:text-surface-0 leading-normal"
                    ><span class="text-primary font-bold">12</span> users have
                    added your products to their wishlist.</span
                >
            </li>
        </ul>
    </div>`
