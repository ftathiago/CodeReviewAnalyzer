...
@Component({
    ...
    template: `<a class="flex items-center" href="#">
            <img src="favicon.png" width="50em" />
            <span
                class="text-surface-900 dark:text-surface-0 font-medium text-2xl leading-normal mr-10"
                >Pull Request Insight</span
            >
        </a>
        ...
        >
            ...
            >
                <li>
                    <a
                        (click)="
                            router.navigate(['/landing'], { fragment: 'home' })
                        "
                        pRipple
